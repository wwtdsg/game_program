...
class Trivia():
    ...
    def show_question(self):
        ...
        if not self.scored and not self.failed:
            print_text(font2, 190, 480, "Press Key 1-4 To Answer", purple)
    ...
    def exit(self):
        screen.fill((0, 0, 200))
        print_text(font1, 50, 100, 'Test finished, you scored %d point(s)' % trivia.score, red)
        print_text(font2, 220, 230, 'Press Enter To Exit', green)
